...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    ...
    if PlayerJob.name == "icecream" then
...
function TakeOutVehicle(vehicleInfo)
    ...
    QBCore.Functions.TriggerCallback('QBCore:Server:SpawnVehicle', function(netId)
        ...
        SetVehicleNumberPlateText(veh, "ICECOLD")
...
function MenuGarage()
    local vehicleMenu = {
        {
            header = Lang:t("text.job_vehicles"),
            isMenuHeader = true
        }
    }
    ...
    for veh, label in pairs(Vehicles) do
        vehicleMenu[#vehicleMenu+1] = {
            ...
            txt = "",
            params = {
                event = "qb-jobcar:client:TakeOutVehicle",
                args = {
                    vehicle = veh
                }
            }
...
RegisterNetEvent('qb-jobcar:client:TakeOutVehicle', function(data)
